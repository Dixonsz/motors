...
from .views.web.orden_servicio_web import orden_detalle, orden_create, orden_editar, orden_cerrar, orden_eliminar
...
urlpatterns = [
    ...
    path('recepciones/crear/', recepcion_create, name='recepcion_crear'),
    ...
    path('ordenes/crear/', orden_create, name='orden_crear'),
