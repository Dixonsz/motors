...
class Cita(models.Model):
    vehiculo = models.ForeignKey('vehiculos.Vehiculo', on_delete=models.CASCADE, related_name='citas', null=True, blank=True)
    cliente  = models.ForeignKey('taller.Cliente',     on_delete=models.PROTECT,  related_name='citas', null=True, blank=True)
    servicio = models.ManyToManyField('agenda.Servicio', related_name='citas', blank=True)
    usuario  = models.ForeignKey('autenticacion.Usuario', on_delete=models.PROTECT, related_name='citas_asignadas')
    fecha       = models.DateField()
    hora_inicio = models.TimeField()
    estado      = models.ForeignKey('vehiculos.Estado', on_delete=models.PROTECT, related_name='citas')
