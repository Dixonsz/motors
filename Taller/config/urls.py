...
from apps.administracion.views.web.auth_web import login_view, recover_account_view, reset_password_view, logout_view

from apps.administracion.views.api.calendario_view import CalendarioApiView
from apps.administracion.views.api.auth_view import login_api
...
urlpatterns = [
    ...
    path('citas/configuraciones/',configuracion_lista,    name='configuracion_lista'),
    path('citas/configuraciones/crear/',configuracion_create,   name='configuracion_crear'),
    path('citas/configuraciones/<int:configuracion_id>/editar/',configuracion_editar,   name='configuracion_editar'),
    path('citas/configuraciones/<int:configuracion_id>/eliminar/',configuracion_eliminar, name='configuracion_eliminar'),
